      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
          ...
          <Typography variant="body1" align="center" color="secondary">Your Location:</Typography>
            <Typography variant="body1" align="center" color="primary">Latitude: {this.props.coords.latitude}</Typography>
            <Typography variant="body1" align="center" color="primary">Longitude: {this.props.coords.longitude}</Typography>
          </Paper>
        </Grid>
      </Grid>
    ) : (
